...
const Eclipse2:FC<EcProps>=(props):JSX.Element=> <>
  <div className=''>
    ...
    <div className={`w-14 h-6 bg-gradient-to-r from-#18282A to-#221A2C relative translate-x-12 right-[420px] top-[405px] z-[9999999] bottom-0 ${props.dark === true ? 'bg-[#111]' :'bg-[#5555e9]' } rounded-full`}></div>
